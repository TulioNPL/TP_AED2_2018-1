...
*Data: 15/03/2018
*Objetivo: Fazer uma pesquisa binaria recursiva na classe Ranking
********************************************************************************/
...
*/
	...
	*/
	public void ordenaAlfabetico() throws Exception{
		...
		for (int i = (n - 1); i > 0; i--) {
				...
				if(array[j].getNumPontos() == array[j+1].getNumPontos()){
					if(posCharDif < 0){
	...
	*/
	...
	/*
        *Metodo: ordenaSelecaoRec()
        *Funcao: fazer uma ordenacao por selecao de forma recursiva
        
        public void ordenaSelecaoRec() throws Exception{
                for (int i = 0; i < (n - 1); i++) {
                        int menor = i;
        ...
        }//fim ordenaSelecaoRec()
	*/
	public void ordenaSelecaoRec() throws Exception{
		ordenaSelecaoRec(0);
	}//fim ordenaSelecaoRec()
	public void ordenaSelecaoRec(int i) throws Exception{
...
class TP01P2Q10{
	...
	*/
	public static void escreveDados(long tempo) throws Exception{
		File arq = new File("605286_selecaoRecursiva.txt");
