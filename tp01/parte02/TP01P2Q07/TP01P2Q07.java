...
*Data: 15/03/2018
*Objetivo: Fazer uma pesquisa sequencial na classe Ranking
********************************************************************************/
...
class Ranking{
	...
	************************************************************************/
	...
	/**
	*Metodo: pesquisa()
	*Funcao: fazer uma pesquisa sequencial pela chave time1	no Ranking
	*/

	public boolean pesquisa(String time1){
	...
	*/
	...
	public static void main(String[] args) throws Exception{
		...
		for(int i = 0; i < qtdChaves; i++){
			existe = ranking.pesquisa(chaves[i]);
			if(existe){
