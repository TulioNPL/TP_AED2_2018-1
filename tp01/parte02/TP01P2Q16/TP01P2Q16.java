...
*Data: 21/03/2018
*Objetivo: Fazer uma ordenacao por bolha na classe Ranking
********************************************************************************/
...
*/
	...
	*/
	public void ordenaAlfabetico() throws Exception{
		...
		for (int i = (n - 1); i > 0; i--) {
				...
				if(array[j].getSaldoGols() == array[j+1].getSaldoGols()){
					if(posCharDif < 0){
	...
	*/
	...
	/*
	*Metodo: bolha()
	*Funcao: fazer uma ordenacao com base no numero de saldo de gols
	*/
...
class TP01P2Q16{
	...
	*/
	public static void escreveDados(long tempo) throws Exception{
		File arq = new File("605286_bolha.txt");
