...
*Data: 19/04/2018
*Objetivo: Fazer uma tabela Hash Direta com Rehash
********************************************************************************/
...
class Hash { 
	...
	*/
	...
	/*
	*Retorna a posicao do elemento na tabela
	*@param elemento int, elemento a receber a posicao
	*@return int, posicao do elemento na tabela
	*/
	...
	/*
	*Retorna posicao do elemento+1 na tabela
	*@param elemento int, elemento a sofrer incremento e receber posicao
	*@return int, posicao na tabela
	*/
	...
	*@return boolean resp, retorna se o elemento foi inserido
	*/
	...
	*@param elemento x, elemento a ser pesquisado
	*@return resp boolean, retorna se o elemento existe ou nao
	*/	
...
class TP03Q06{
	...
	*/
	public static void escreveDados(long tempo) throws Exception{
		File arq = new File("605286_hashReHash.txt");
