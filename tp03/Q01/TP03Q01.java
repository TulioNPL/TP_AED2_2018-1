...
*Data: 19/04/2018
*Objetivo: Fazer uma Arvore Binaria de times
********************************************************************************/
...
class ArvoreBinaria {
	...
	public static int comp;
    	...
    	private boolean pesquisar(String x, No i) {
        	...
        	if (i == null) {
         		...
         		resp = true;
			comp++;
      		} else if (i.elemento.getPais().compareTo(x) > 0) {
			comp+=2;
			MyIO.print("esq ");
    	...
    	private void mostrarCentral(No i) {
        	if (i != null) {
            		...
            		MyIO.print(i.elemento.getNumPontos()+"("+i.elemento.getPais()+") "); // Conteudo do no.
    	...
    	private No inserir(Time x, No i) throws Exception {
        	if (i == null) {
         		i = new No(x);
      		} else if (x.getPais().compareTo(i.elemento.getPais()) < 0) {
			comp++;
	...
	private No remover(String x, No i) throws Exception {
     	...
     	* @return No em analise, alterado ou nao.
     	*/
    	private No antecessor(No i, No j) throws Exception {
      		// Existe no a direita.
        	if (j.dir != null) {
...
class TP03Q01{
	...
	*/
	public static void escreveDados(long tempo) throws Exception{
		...
		bw.write("605286\tTempo de execução: "+tempo/1000.0+" s.\tNúmero de comparações: "+ArvoreBinaria.comp);
		bw.close();
	}//fim escreveDados()
	...
	*/
	public static void removeSedes(ArvoreBinaria arvore) throws Exception {
