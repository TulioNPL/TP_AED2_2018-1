...
*Data: 19/04/2018
*Objetivo: Fazer uma tabela Hash Indireta com Lista SImples
********************************************************************************/
...
class Celula {
     	...
     	*/
    	Celula(Time elemento, Celula prox) {
        	this.elemento = elemento;
        	this.prox = prox;
    	}//end Celula()
}//end class Celula
...
class Lista {
    	...
    	public void mostrar() {
        	...
        	for (Celula i = primeiro.prox; i != null; i = i.prox) {
            		System.out.print(i.elemento.getPais() + " ");
        	}
    	...
    	public boolean pesquisar(String x) {
        	...
        	for (Celula i = primeiro.prox; i != null; i = i.prox) {
         		if(i.elemento.getPais().equals(x)){
            			retorno = true;
            			i = ultimo;
         		}//end if
			HashIndiretoLista.comp++;
        	}//end for
        	return retorno;
    	}//end pesquisar()
     	...
     	*/
    	public void inserirInicio(Time elemento) {
...
class HashIndiretoLista {
	...
	*/
	...
	/*
	*Construtor da classe
	*@param tamanho int, tamanho da tabela
	*/
	...
	/*
	*Faz o Hash
	*@param elemento int, elemento a sofrer Hash
	*@return int, resultado do Hash
	*/
	...
	/*
	*Pesquisa o elemento a tabela
	*@param elemento String, elemento a ser pesquisado
	*@return boolean, retorna se o elemento existe ou nao
	*/
	...
	*@param elemento Time, elemento a ser inserido
	*/
   	public void inserir(Time elemento) {
      		int pos = h(elemento.getNumPontos());
      		tabela[pos].inserirInicio(elemento);
   	}//end inserirInicio()
}//end class HashIndiretoLista
...
class TP03Q07 {
	...
	*/
	public static void escreveDados(long tempo) throws Exception{
		File arq = new File("605286_hashIndireta.txt");
		FileWriter fw = new FileWriter(arq);
		BufferedWriter bw = new BufferedWriter(fw);

		bw.write("605286\tTempo de execução: "+tempo/1000.0+" s.\tNúmero de comparações: "+HashIndiretoLista.comp);
		bw.close();
	}//fim escreveDados()
