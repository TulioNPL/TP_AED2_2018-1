...
container.timeout=setTimeout(function(){placetext.placeText(container,txt,!1,minFontSize,showFunction)},16)}
else{var lh=Number(txt.css('line-height').replace('px',''));lh=lh*(s/(s+1));txt.css('font-size',s+'px');txt.css('line-height',lh+'px');container.timeout=setTimeout(function(){placetext.placeText(container,txt,!0,minFontSize,showFunction,html)},8)}}
